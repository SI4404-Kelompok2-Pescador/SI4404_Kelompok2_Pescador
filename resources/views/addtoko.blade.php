        ...
        <div class="card mb-2 mb-lg-0" style="height: 1rem;">
          <div class="card-body p-0">
            <ul class="list-group list-group-flush rounded-3">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-3" >Rp.3.000.000</p>
              </div>
              <div class="d-flex justify-content-center mb-1">
              <a href="topup"><button type="button" class="btn btn-outline-primary ms-1 mt-2"style="width: 10rem;">CHECK</button></a>
            </div>
              </li>
            </ul>
          </div>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">ABDI JAYA</p>
              </div>
            </div>
            <hr>
            <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card mb-4 mb-md-0"style="height:10rem;">
              <div class="card-body">
                ...
                <a href="order"><button type="button" class="btn btn-primary" style="width: 15rem;">View</button></a>
              </div>
              </div>
            </div>
          </div>
          <div class="col-md-6" >
            <div class="card mb-4 mb-md-0"style="height:10rem;">
              ...
              <div class="d-flex justify-content-center mb-2 mt-4">
                <div>
                <button type="button" class="btn btn-primary" style="width: 15rem;" data-bs-toggle="modal" data-bs-target="#staticBackdrop">ADD</button>
                <!-- Modal -->
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                         <form>
                            ...
                            <label for="recipient-name" class="col-form-label">CATEGORY</label>
                              <input type="text" class="form-control" name="category" id="category" placeholder="(CUMI-CUMI/UDANG/..)">
                            <label for="recipient-name" class="col-form-label">IMAGE</label>
                              <input type="file" class="form-control" name="image" id="image" name="gambar" style="height: 40px;">  
                            <div class="mb-3">
                              <label for="message-text" class="col-form-label">DESCRIPTION</label>
                              <textarea class="form-control" id="message-text" type="text" class="form-control" name="description" id="password" ></textarea>
                            </div>
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="{{'toko'}}"><button type="button" class="btn btn-primary" type="submit" name="submit">ADD</button></a>   
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <a href="productview"><button type="button" class="btn btn-secondary" style="width: 15rem; margin-left:10px;">View</button></a>
              </div>
            </div>
          </div>
        </div>
